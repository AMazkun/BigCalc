...
struct CalcButtomLandscapeExt: View {
    ...
    var body: some View {
        VStack(spacing: 4) {
            ...
            HStack(spacing: 4){
                ...
                CalcButtomView(index: 40)
                CalcButtomView(index: 41)
            ...
            HStack(spacing: 4){
                ...
                CalcButtomView(index: 37)
                CalcButtomView(index: 36)
...
struct CalcButtomPadLandscapeExt_Previews: PreviewProvider {
    @StateObject static var calculator = CalculatorLogic()

    static var previews: some View {
        CalcButtomLandscapeExt().environmentObject(calculator)
